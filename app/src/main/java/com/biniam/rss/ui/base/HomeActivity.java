...
import com.biniam.rss.ui.controllers.NavigationSelectionListener;
import com.biniam.rss.ui.utils.BottomNavigationViewEx;
import com.biniam.rss.ui.utils.SectionedDividerDecoration;
import com.biniam.rss.ui.viewmodels.FeedListItemModel;
import com.biniam.rss.ui.viewmodels.FeedListViewModel;
    ...
    private void updateNavigationList() {
        ...
        new Observable<List<NavigationItem>>() {
            ...
            protected void subscribeActual(io.reactivex.Observer<? super List<NavigationItem>> observer) {
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeWith(new DisposableObserver<List<com.biniam.rss.ui.controllers.NavigationItem>>() {
                    @Override
