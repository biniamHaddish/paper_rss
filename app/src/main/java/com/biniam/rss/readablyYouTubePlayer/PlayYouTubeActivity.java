package com.biniam.rss.readablyYouTubePlayer;
 ...
 * <p>
 * This Activity Will play YouTube video Directly inside Readably App {@link com.biniam.rss.readablyYouTubePlayer}
 */
        ...
        if (id != null || !id.isEmpty()) {
            youTubePlayerView.initialize(Constants.YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
                ...
                public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                    Utils.showToast(ReadablyApp.getInstance(), "Can not play the video.");
                }
            });
        }
    }
