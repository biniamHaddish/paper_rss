package com.biniam.rss.expandablerv;
...
import com.biniam.rss.expandablerv.listeners.ExpandCollapseListener;
import com.biniam.rss.expandablerv.listeners.GroupExpandCollapseListener;
import com.biniam.rss.expandablerv.listeners.OnGroupClickListener;
import com.biniam.rss.expandablerv.viewholders.ChildViewHolder;
import com.biniam.rss.expandablerv.viewholders.GroupViewHolder;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    private Set<String> expandedTitles;

    public ExpandableRecyclerViewAdapter(List<? extends ExpandableGroup> groups, Set<String> expandedTitles) {
        this.expandedTitles = expandedTitles;
        this.expandableList = new ExpandableList(groups, expandedTitles);
    ...
    public void onGroupExpanded(int positionStart, int itemCount) {
        //updateFeedListDateSections header
    ...
    public Set<String> getExpandedTitles() {
