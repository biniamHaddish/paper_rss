...
public class PaperPrefs implements SharedPreferences.OnSharedPreferenceChangeListener {

    // Theme constants
    public static final int AUTO_THEME = 0;
    public static final int LIGHT_THEME = 1;
    public static final int DARK_THEME = 2;
    private static PaperPrefs paperPrefs;
    ...
    private PaperPrefs(Context context) {
    ...
    public static PaperPrefs getInstance(Context context) {
        if (paperPrefs == null) {
            paperPrefs = new PaperPrefs(context);
        }
        return paperPrefs;
    }
    ...
    private void updatePrefs() {
        ...
        unreadItemsToKeep = Integer.valueOf(sharedPreferences.getString(getString(R.string.pref_read_Items_keep_key), "1"));
